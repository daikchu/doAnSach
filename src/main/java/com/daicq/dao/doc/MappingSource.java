...
public class MappingSource implements Serializable {
	...
	public List<MapsObject> getMaps() {
		return maps;
	}

	public void setMaps(List<MapsObject> maps) {
		this.maps = maps;
	}
	...
	public MappingSource(String key, String mappingId, Long id, String type, List<MapsObject> maps, String mappingName, String description, String mappingType) {
		super();
		this.key = key;
		this.mappingId = mappingId;
		this.id = id;
