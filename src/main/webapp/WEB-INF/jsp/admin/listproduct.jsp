                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <c:forEach items="${productList}" var="productList">
                                <tr>
                                    ...
                                    <td><a href="/admin/editproduct?id=${productList.id}"><img src="/assets/img/icon/edit.svg " height="20" width="20" ></a></td>
                                        <%--<a href="/admin/editproduct?id=${productList.id}"></a></td>--%>

                                    <td><a href="/deletepro/${productList.id}"><img src="/assets/img/icon/delete.svg " height="20"
                                             width="20"></a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
